...
public class ProductMappingProfile : Profile
{
    public ProductMappingProfile()
    {
        ...
        CreateMap<InventoryItem, InventoryItemDto>()
            ...
            .ForMember(dest => dest.PurchasePrice, opt => opt.MapFrom(src => src.Product.PurchasePrice))
            .ForMember(dest => dest.RentalPrice, opt => opt.MapFrom(src => src.Product.RentalPrice))
            .ForMember(dest => dest.SecurityDeposit, opt => opt.MapFrom(src => src.Product.SecurityDeposit))
