...
CONTROLLER_DIR="Services/CategoryService/CategoryService.API/Controllers"
mkdir -p "$CONTROLLER_DIR"

cat > "$CONTROLLER_DIR/CategoryController.cs" <<EOF
using MediatR;
...
echo "✅ CategoryController created at $CONTROLLER_DIR"
