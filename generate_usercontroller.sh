...
echo "🌐 Generating UserController..."

API_DIR="./services/UserService/UserService.API/Controllers"
mkdir -p "$API_DIR"

cat > "$API_DIR/UserController.cs" <<EOF
using MediatR;
...
echo "✅ UserController generated at $API_DIR/UserController.cs"
